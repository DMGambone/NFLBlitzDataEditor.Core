...
namespace NFLBlitzDataEditor.Core.Models
{
    ...
    public class Team
    {
        ...
        /// The team logo image
        /// </summary>
        public ImageInfo TeamLogo { get; set; }

        /// <summary>
        /// The team logo image??
        /// </summary>
        public ImageInfo TeamLogo30 { get; set; }

        /// <summary>
        /// The team name image
        /// </summary>
        public ImageInfo TeamSelectionImage { get; set; }
        #endregion
    }
}