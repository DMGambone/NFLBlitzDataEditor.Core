...
namespace MidwayGamesFS
{
    ...
    {
        /// <summary>
        /// The CRC values used to calculate the checksum of a collection of bytes
        /// </summary>
        ...
        /// <summary>
        /// Calculates the checksum on a collection of bytes
        /// </summary>
        /// <param name="data">The data to calculate the checksum on</param>
        /// <returns>The computed checksum</returns>
        public uint Compute(byte[] data)
        {
            return Compute(new MemoryStream(data));
        }

        /// <summary>
        /// Calculates the checksum on a stream of data
        /// </summary>
        /// <param name="data">The stream containing the data to calculate the checksum on</param>
        /// <returns>The computed checksum</returns>
        public uint Compute(Stream stream)
        {
            ...
            while ((value = stream.ReadByte()) != -1)
            {
                ...
                v0 = a2 << 8;
                a2 = v0 ^ v1; // update a2 for next lookup
            }
